...
## Links
Question [here](https://leetcode.com/problems/gas-station/description/) and solution [here](https://github.com/etherion-1337/LeetCode/blob/master/medium/134_gas_station/solution.py)

## Solution

### concept
from starting pos, track total gas (to be precise: gas - cost) currently the car has and reset once this total < 0
